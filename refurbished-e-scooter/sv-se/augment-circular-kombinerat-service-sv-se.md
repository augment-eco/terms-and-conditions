# AUGMENT CIRCULAR AVTALSVILLKOR
...
"Enhet" en begagnad och rekonditionerad Augment Circular elsparkcykel.
"Serviceavtal" Augments tidsbegränsade service enligt dessa villkor.
"Stöldskydd" Augments tjänst enligt vilken en stulen enhet ersätts enligt dessa villkor.
"Snabbbyteservice" en tjänst där enheten ersätts med en annan begagnad enhet utan föregående reparation.
...
Batteriets kapacitet är vid försäljningstillfället minst 75 % av ett nytt motsvarande batteri.

Batteriets kapacitet minskar normalt över tid vid användning.
...
Konsumenten har 14 dagars ångerrätt.
...
Enheten har ingen garanti.

Augment ansvarar för fel enligt konsumentskyddslagstiftningen.
...
Augment står för returfrakt enligt instruktion.
...
Dessa allmänna villkor för Augment gäller i Sverige från 10.04.2026 tills vidare.
