# AUGMENT STÖLDSKYDD AVTALSVILLKOR

Gäller från 10.04.2026

## 1. AVTALETS TILLÄMPNING

Detta avtal innehåller två alternativa modeller:

- A-DEL: KÖP
- B-DEL: SERVICEAVTAL

Kunden väljer vid beställning.
...
Stöldskyddet är dock beroende av det avtal som gäller köp av enheten samt eventuella tilläggstjänster ("huvudavtalet").
...
Stöldskyddet gäller endast den enhet eller ersättningsenhet som har levererats till kunden med stöd av huvudavtalet.
...
Vid misstänkt eller konstaterad stöld ska kunden:

- utan dröjsmål meddela Augment
- göra en polisanmälan inom 10 arbetsdagar
- tillhandahålla en kopia av polisanmälan till Augment
...
Om villkoren för stöldskyddet är uppfyllda levererar Augment en ersättningsenhet till kunden.

Ersättningsenheten är en rekonditionerad begagnad enhet.

Augment har rätt att bestämma ersättningsenhetens modell, skick och specifikationer.
...
- låsningskraven enligt dessa villkor inte har följts
- enheten har lånats ut till en person som inte tillhör kundens hushåll
- enheten har använts yrkesmässigt eller kommersiellt
- kunden inte har gjort polisanmälan inom angiven tid
- kunden inte kan uppvisa begärd dokumentation
...
Stöldskyddet är en tidsbegränsad tjänst som betalas i sin helhet vid beställningen.

Betalningssättet påverkar inte avtalets giltighet.
...
Dessa villkor gäller från den 10.04.2026 tills annat anges.
