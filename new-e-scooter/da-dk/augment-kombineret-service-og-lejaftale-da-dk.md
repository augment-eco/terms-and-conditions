# AUGMENT KOMBINERET SERVICE OG LEJEAFTALE
...
Hvis kunden har valgt købsmuligheden mod et ekstra gebyr på **37 DKK/måned**, kan de købe el-løbehjulet for **10 DKK** efter kontraktens bindingsperiode. Når købsprisen er betalt, ophører denne kontrakt automatisk.
...
Betalinger i henhold til **aftalen** er pantsat til fordel for Norion Bank AB, finsk filial som **panthaver**. Ingen andre end **panthaveren** må foretage ændringer i betalingsinstruksen.
...
Disse vilkår og betingelser for Augment er gældende i Danmark **fra 24.10.2025** indtil videre.
