...
Detta avtal innehåller två alternativa anskaffningsmodeller:

- A-DEL: KÖP AV PRODUKT (30.03.2026)
- B-DEL: SERVICEAVTAL (08.04.2026)

Kunden väljer vid beställning vilken modell som tillämpas.
...
**"Stöldskydd"** Augments tjänst enligt vilken en stulen enhet ersätts i enlighet med dessa villkor.
**"Snabbbyteservice"** en tjänst där kundens enhet ersätts med en ersättningsenhet utan att den ursprungliga enheten repareras först.
...
1. villkor för köp av enheten
2. villkor för tilläggsprodukter
3. villkor för serviceavtal (om det valts)
4. villkor för stöldskydd (om det valts)

Samtliga villkor bildar ett gemensamt och sammanhängande avtalsförhållande.
...
Tilläggstjänsterna ingår inte i köpet av enheten om kunden inte har valt dem separat.

Kunden betalar ett separat pris för tilläggstjänsterna i samband med beställningen.
...
Enheten säljs till kunden.

Äganderätten övergår till kunden när:
...
Kunden kan betala beställningen:

- som engångsbetalning, eller
- med konsumentfinansiering
...
Serviceavtal och stöldskydd:

- är tidsbegränsade tjänster
- anses vara betalda i sin helhet vid tidpunkten då avtalet uppstår
- kan inte sägas upp under pågående avtalsperiod
...
Kunden kan köpa tilläggsprodukter, till exempel lås eller hjälm.

Tilläggsprodukterna är separata varor och omfattas av normala köpvillkor.
...
Leveranstiden är normalt 1–5 arbetsdagar.
...
Produkten har 24 månaders garanti.

Garantin begränsar inte kundens rättigheter enligt tvingande konsumentskyddslagstiftning.

Augment har i första hand rätt att reparera eller byta ut produkten.

När det gäller batteriet konstateras särskilt att batterikapaciteten minskar vid normal användning.

Om enheten har använts normalt förväntas batterikapaciteten uppgå till minst 75 % av den ursprungliga kapaciteten efter 24 månaders användning.

En minskning av batterikapaciteten som håller sig ovanför denna nivå anses vara normalt slitage och ger inte rätt till reparation eller byte inom garantin.

<div class="page"></div>

## 10. Användning av enheten och mobilapplikation

Användning av enheten förutsätter att Augments mobilapplikation används.

Kunden ansvarar för att:

- ha en kompatibel mobil enhet
- applikationen finns tillgänglig och kan användas

Augment ansvarar inte för avbrott i användningen som beror på kundens utrustning eller programvara.
...
Det gäller endast om kunden har valt tjänsten i samband med beställningen.
...
Serviceavtalet omfattar fel som uppstår vid normal användning samt slitdelar, såsom däck, bromsbelägg och batteri, samt en (1) skadehändelse per 12-månadersperiod.

Med skadehändelse avses en plötslig och oförutsedd yttre händelse.
...
Som skadehändelse räknas inte:

- avsiktligt orsakad skada
- skada som beror på grov vårdslöshet

Det konstateras dessutom att fel som endast påverkar enhetens utseende, såsom repor, märken eller andra visuella skador på de främre eller bakre plastpanelerna, inte ger rätt att beställa en ersättningsenhet genom snabbbyteservice.

I sådana fall levererar Augment nödvändiga reservdelar till kunden, och kunden kan själv byta delarna enligt Augments instruktioner.
...
Augment bedömer situationen och avgör om följande åtgärd ska användas:
...
- klistermärken eller tejpningar
- målning
...
- i den förpackning som Augment har tillhandahållit
- med den returfraktsedel som Augment har tillhandahållit

Augment ansvarar för returfraktkostnaden om instruktionerna följs.
...
Kunden kan välja egenreparation, varvid Augment levererar reservdelarna.
...
Serviceavtalet omfattar inte yrkesmässig användning.

Med yrkesmässig användning avses användning för inkomstförvärv, såsom:

- matleveranstjänster
- bud- och distributionsverksamhet
...
Enbart förvaring i ett delat utrymme utan fysisk låsning uppfyller inte kraven i dessa villkor.
...
- låsningskraven inte har följts
- enheten har lånats ut till någon som inte tillhör kundens hushåll
...
Augment ansvarar inte för force majeure-situationer.
...
## (GÄLLER FRÅN 08.04.2026)

# AUGMENT KOMBINERAT SERVICE OCH HYRESAVTAL
...
- Oväntade **skador**, till exempel att skotern går sönder på grund av en kollision eller att den välter omkull. Under **avtalstiden** är antalet skador som ersätts begränsat till högst ett ärende per år.
...
Dessa villkor för Augment gäller i Sverige från 10.04.2026 och tills vidare.
